 ...
 const Weather = () => {
   ...
   return (
    <div className="bg-blue-200 h-[61rem]">
            ...
            <div className="flex items-center justify-center mt-[3rem] gap-[0.5rem]">
                ...
                <div onClick={handleSearch} className="">
                    <Button
                        ...
                        text={
                            loading ? (
                                <AiOutlineLoading3Quarters className="text-xl animate-spin ml-[3.5rem] md:ml-[4.5rem]" />
                            ) : (
                                "Search Now"
                            )
                        }
        ...
        {error && <p className='error text-center  text-xl mt-[1.5rem]  font-bold md:mt-[3rem] md:text-2xl text-red-600 md:font-bold'>{error}</p>}
